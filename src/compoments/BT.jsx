...
<div
        className={` md:hidden absolute right-0 bg-gray-400  shadow-md overflow-hidden  transition-all duration-1000 ease-in-out ${showSearch ? "max-h-20 opacity-100" : "max-h-0 opacity-0"}`}
      >
        <form action="">
          <input
            type="text"
